       ...
       child: Column(
         children: [
           Expanded(flex: 1,
            ...
            QuranHeaderWidget(),
           Expanded(flex: 2,
             child: ListView.separated(itemBuilder: (context,index)=>SuranmeWidget(suraItem: SuraItem(suraName: SuraNames[index], versesNumber: VersesNum[index].toString(),index: index)),
                 separatorBuilder: (context,index)=>Container(width: double.infinity,height:3,color:Theme.of(context).dividerColor), itemCount:SuraNames.length ),
           )
         ],
       ),
    );
